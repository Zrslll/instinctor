---
name: instinctor
description: Instinct-based learning system that observes sessions via hooks, creates atomic instincts with confidence scoring, and injects them into future sessions. Project-scoped instincts prevent cross-project contamination.
...
A learning system that turns your Claude Code sessions into reusable knowledge through atomic "instincts" — small learned behaviors with confidence scoring.
