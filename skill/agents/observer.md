...
- Project: `~/.claude/instinctor/projects/<project-hash>/observations.jsonl`
- Global fallback: `~/.claude/instinctor/observations.jsonl`
...
- Project: `~/.claude/instinctor/projects/<project-hash>/instincts/personal/`
- Global: `~/.claude/instinctor/instincts/personal/` (for universal patterns)
